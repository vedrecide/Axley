...
class Music(commands.Cog, wavelink.WavelinkMixin):
    ...
    @commands.command(
        ...
        description='Bot Joins the Voice Channel mentioned or it just joins your voice channel'
    )
    @commands.guild_only()
    async def connect(self, ctx: commands.Context, *, channel: t.Optional[discord.VoiceChannel]):
    ...
    @commands.command(
        ...
        description="Leave's the Voice Channel"
    )
    @commands.guild_only()
    ...
    @commands.command(
        ...
        description="Stop's basically everything"
    )
    @commands.guild_only()
    ...
    @commands.command(
        ...
        description="Play's the next song in the Queue, if any"
    )
    @commands.guild_only()
    ...
    @commands.command(
        ...
        description='Plays the previous song in the queue, if any'
    )
    @commands.guild_only()
